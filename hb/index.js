...
var $author$project$Main$initModel = {age: 42, firstname: '', message: 'Welcome'};
		...
		switch (msg.$) {
			case 'MsgSurprise':
				return _Utils_update(
					model,
					{
						message: 'Happy ' + ($elm$core$String$fromInt(model.age) + (' birthday ' + model.firstname))
					});
			case 'MsgReset':
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Surprise btn')
					])),
				A2(
				$elm$html$Html$button,
				_List_fromArray(
